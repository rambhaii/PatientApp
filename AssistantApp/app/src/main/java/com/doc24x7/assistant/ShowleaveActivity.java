...
import com.doc24x7.assistant.DoctorDashboad.LeaveAdapter;
import com.doc24x7.assistant.DoctorDashboad.LeaveAdapterday;
...
//
      id=  balanceCheckResponse.getId();
       ...
       loader=new Loader(this,android.R.style.Theme_Translucent_NoTitleBar);
        ...
        adapter=new LeaveAdapter(leaveDatalist, com.doc24x7.assistant.ShowleaveActivity.this,selectedAll,deleteselected);
       ...
       // showleavebyDate();
        ...
        show_date_leave.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        show_day_leave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
       ...
       loader.isShowing();
             ...
             //    Toast.makeText(ShowleaveActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                try {
                    ...
                    if(jsonArray.isNull(0)) {
                        Toast.makeText(com.doc24x7.assistant.ShowleaveActivity.this, "No Leave", Toast.LENGTH_SHORT).show();
                        loader.dismiss();
                    }
        ...
        }, new Response.ErrorListener()
        {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(com.doc24x7.assistant.ShowleaveActivity.this, "Network is slow", Toast.LENGTH_SHORT).show();
                loader.dismiss();
            }
        })
            ...
            public void onResponse(String response) {
               // Toast.makeText(ShowleaveActivity.this, ""+response, Toast.LENGTH_SHORT).show();
                try {
                    ...
                    adapterday=new LeaveAdapterday(leaveDatalistschedule, com.doc24x7.assistant.ShowleaveActivity.this,selectedAll,deleteselected);
