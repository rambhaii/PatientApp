...
@FormUrlEncoded
    ...
    @GET("/api/Payment/chkpayment")
    Call<secureLoginResponse> chkpayments(@Header("X-API-KEY") String authorization,
                                         @Query("user_id") String user_id,
                                         @Query("doctor_id") String doctor_id,
 ...
 @GET("/api/Doctors/GetDrProfileData")
    ...
    @FormUrlEncoded
    @POST("/api/AssistantBookAppointment/BookAppointment")
