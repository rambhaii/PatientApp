...
public class DoctorAvalibalAdapterOffline extends RecyclerView.Adapter<DoctorAvalibalAdapterOffline.MyViewHolder> implements CompoundButton.OnCheckedChangeListener {
   ...
   public Context mContext;
    ...
    CheckBox monch, tuech, wedch, thusch, frich, satch, sunch ,selectedAllcheck;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_title, tv_discuraption, craetedate, enddate, noofpatient, selectedAll,numberofpa;
    ...
    public DoctorAvalibalAdapterOffline(ArrayList<Datum> transactionsList, Context mContext, String day, TextView deleteselected, CheckBox selectedAllcheck,TextView notAvailable) {
        this.transactionsList = transactionsList;
        this.mContext = mContext;
        this.day = day;
        transactionsListNew = new ArrayList<>();
        this.deleteselected = deleteselected;
        this.selectedAllcheck = selectedAllcheck;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < transactionsListNew.size(); i++) {
                    if (UtilMethods.INSTANCE.isNetworkAvialable(mContext)) {
                        UtilMethods.INSTANCE.DeleteAvailabilityOffline(mContext, transactionsListNew.get(i).getId(), day, loader, transactionsListNew.size(), i + 1,notAvailable);
      ...
      /*  selectedAll.setOnClickListener(new View.OnClickListener() {
        ...
        selectedAllcheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                                      ...
                                      // long num = (min / Long.parseLong(numberofpa.getText().toString().trim()));
                                        ...
                                        for (int i = 0; i < updateAvilabilityday.size(); i++) {
                                            if(updateAvilabilityday.get(i).equalsIgnoreCase(day)){
                                                UtilMethods.INSTANCE.UpdateAvailabilityOffline(mContext, "" + starttime.getText().toString(),
                                                ...
                                                long num=(min/ Long.parseLong(numberofpa.getText().toString().trim()));
                                                UtilMethods.INSTANCE.SetAvailabilityOffline(mContext, "", "" + starttime.getText().toString().trim(),
                                                        "" + endtime.getText().toString().trim(), "", loader,
                                                        updateAvilabilityday.get(i), type==1? numberofpa.getText().toString().trim():num+"",updateAvilabilityday,notAvailable);
                                            }
                                            Log.e("daysssss:",updateAvilabilityday.get(i));
                                            if (i == updateAvilabilityday.size() - 1) {
                                                UtilMethods.INSTANCE.GetAvailabilityOffline(mContext, day, loader,notAvailable);
                                                dialog.dismiss();
                                            }
                                        }
                                    }
              ...
              //  monch.setOnClickListener(this);
                ...
                monch.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                tuech.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                wedch.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                thusch.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                frich.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                satch.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                sunch.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                patientrd.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                radiord.setOnCheckedChangeListener(DoctorAvalibalAdapterOffline.this::onCheckedChanged);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (UtilMethods.INSTANCE.isNetworkAvialable(mContext)) {
                         //   Toast.makeText(mContext, ""+operator.getId(), Toast.LENGTH_SHORT).show();
                            ...
                            loader.setCancelable(false);
                            loader.setCanceledOnTouchOutside(false);
                            UtilMethods.INSTANCE.DeleteAvailabilityOffline(mContext, operator.getId(), day, loader, 1, 1,notAvailable);
                        } else {
                            UtilMethods.INSTANCE.NetworkError(mContext, mContext.getResources().getString(R.string.network_error_title),
                                    mContext.getResources().getString(R.string.network_error_message));
                        }
