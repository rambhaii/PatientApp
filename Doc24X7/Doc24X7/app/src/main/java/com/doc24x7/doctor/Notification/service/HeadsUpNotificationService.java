...
public class HeadsUpNotificationService extends Service implements MediaPlayer.OnPreparedListener  {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= 28)
        {
            ...
            Intent intent = new Intent(this, NotificationSend.class);
...
//            callDialogAction.setAction("DIALOG_CALL");
            ...
            h.postDelayed(new Runnable() {
                ...
                public void run()
                {
                    PendingIntent.getBroadcast(getApplicationContext(), 1201, cancelCallAction, PendingIntent.FLAG_UPDATE_CURRENT);
                }
            },15000);
