...
import com.doc24x7.doctor.Video.model.DuringCallEventHandler;
import com.doc24x7.doctor.Video.model.Message;
import com.doc24x7.doctor.Video.model.User;
import com.doc24x7.doctor.Video.model.UserStatusData;
import com.doc24x7.doctor.Video.model.VideoInfoData;
import com.doc24x7.doctor.Video.propeller.Constant;
import com.doc24x7.doctor.Video.propeller.ui.RecyclerItemClickListener;
import com.doc24x7.doctor.Video.propeller.ui.RtlLinearLayoutManager;
import com.doc24x7.doctor.Video.ui.BaseActivity;
import com.doc24x7.doctor.Video.ui.CallOptionsActivity;
import com.doc24x7.doctor.Video.ui.layout.GridVideoViewContainer;
import com.doc24x7.doctor.Video.ui.layout.InChannelMessageListAdapter;
import com.doc24x7.doctor.Video.ui.layout.MessageListDecoration;
import com.doc24x7.doctor.Video.ui.layout.SmallVideoViewAdapter;
import com.doc24x7.doctor.Video.ui.layout.SmallVideoViewDecoration;
...
public class CallActivity extends BaseActivity implements DuringCallEventHandler , RtmChannelListener, ResultCallback<Void> {
    ...
    protected RtmCallManager rtmCallManager() {
        ...
        try {
            ...
            LocalInvitation invitation = rtmCallManager.createLocalInvitation(userid);
    ...
    protected void initUIandEvent() {
        ...
        joinChannel(channelName, config().mUid, getIntent().getStringExtra(ConstantApp.ACCESS_TOKEN));
    ...
    private void showOrHideCtrlViews(boolean hide) {
        ...
        findViewById(R.id.extra_ops_container).setVisibility(hide ? View.INVISIBLE : View.INVISIBLE);
        findViewById(R.id.linerbottom).setVisibility(hide ? View.INVISIBLE : View.VISIBLE);
        findViewById(R.id.bottom_action_container).setVisibility(hide ? View.INVISIBLE : View.INVISIBLE);
        findViewById(R.id.msg_list).setVisibility(hide ? View.INVISIBLE : (Constant.DEBUG_INFO_ENABLED ? View.INVISIBLE : View.INVISIBLE));
    }
    ...
    private void doLeaveChannel() {
        ...
        UtilMethods.INSTANCE.UploadRecordFile(this, userid, Appointment_id, path);
      //  UtilMethods.INSTANCE.StopRecording(this, getIntent().getStringExtra(ConstantApp.ACTION_KEY_CHANNEL_NAME), Uid, resourceID, sid);
    ...
    public void onVideoMuteClicked(View view) {
        ...
        iv.setImageResource(mVideoMuted ? R.drawable.videocam_off : R.drawable.videocam);
    ...
    public void onVoiceMuteClicked(View view) {
        ...
        iv.setImageResource(mAudioMuted ? R.drawable.mic_off : R.drawable.mic_icon);
    }
    ...
    public void onUserJoined(final int uid) {
        ...
        rtcEngine.startAudioRecording(Environment.getExternalStorageDirectory() + "/Android/" + userid + ".mp4", 2, 2);
        File directory = new File(Environment.getExternalStorageDirectory()+"/Android");
        if(!directory.exists())
        directory.mkdirs();
        path = Environment.getExternalStorageDirectory() + "/Android/" + userid + ".mp4";
        //path=Environment.getExternalStorageDirectory()+"/doc/jitu.png";
    }
    ...
    public void onJoinChannelSuccess(String channel, final int uid, int elapsed) {
        ...
        Uid = uid;
        log.error("onUserJoined " + (uid & 0xFFFFFFFFL));
        Log.e("onUserJoined ", (uid) + "");
       // UtilMethods.INSTANCE.StartRecording(this, getIntent().getStringExtra(ConstantApp.ACTION_KEY_CHANNEL_NAME), uid);
        ...
        switch (type) {
            ...
            case AGEventHandler.EVENT_TYPE_ON_APP_ERROR:
                ...
                if (subType == ConstantApp.AppError.NO_CONNECTION_ERROR) {
                    String msg = "R.string.msg_connection_error";
    ...
    public void notifyHeadsetPlugged(final int routing) {
        ...
        if (mAudioRouting == Constants.AUDIO_ROUTE_SPEAKERPHONE) {
            iv.setImageResource(R.drawable.volume_on_icon);
        } else {
            iv.setImageResource(R.drawable.volume_off_icon);
        }
    }
