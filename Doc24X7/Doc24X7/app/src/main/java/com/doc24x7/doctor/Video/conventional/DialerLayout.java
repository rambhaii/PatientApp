package com.doc24x7.doctor.Video.conventional;
...
import com.doc24x7.doctor.Video.Constants;
import com.doc24x7.doctor.Video.DialerActivity;
import com.doc24x7.doctor.Video.EngineEventListener;
import com.doc24x7.doctor.Video.RtcUtils;
...
public class DialerLayout extends RelativeLayout implements View.OnClickListener {
    ...
    public void adjustScreenWidth(int width) {
        ...
        LayoutParams params =
                (LayoutParams) callNumberLayout.getLayoutParams();
        int margin = width / 10;
        ...
        params = (LayoutParams) dialNumberLayout.getLayoutParams();
        params.leftMargin = margin;
        params.rightMargin = margin;
    ...
    private void startCall() throws Exception {
        ...
        if (mActivity != null) {
            ...
            mRtmClient.queryPeersOnlineStatus(peerSet,
