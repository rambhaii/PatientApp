...
public class SpecialitiesAdapter extends RecyclerView.Adapter<SpecialitiesAdapter.MyViewHolder> {
    ...
    public SpecialitiesAdapter(ArrayList<Datum> transactionsList, Context mContext) {
    ...
    public SpecialitiesAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.specialities_product_adapter, parent, false);
    ...
    @Override
    public void onBindViewHolder(final SpecialitiesAdapter.MyViewHolder holder, int position) {
