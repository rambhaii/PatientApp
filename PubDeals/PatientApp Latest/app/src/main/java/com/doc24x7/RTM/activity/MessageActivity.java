package com.doc24x7.RTM.activity;
...
import com.doc24x7.RTM.MessageAdapter;
import com.doc24x7.RTM.model.MessageBean;
import com.doc24x7.RTM.model.MessageListBean;
import com.doc24x7.RTM.rtmtutorial.ChatManager;
import com.doc24x7.RTM.utils.ImageUtil;
...
public class MessageActivity extends Activity {
    ...
    private void init() {
        ...
        String targetName = intent.getStringExtra(MessageUtil.INTENT_EXTRA_TARGET_NAME);
          String doctname=intent.getStringExtra("doctorname");
        mTitleTextView = findViewById(R.id.message_title);
        if (mIsPeerToPeerMode) {
            mPeerId = targetName;
            mTitleTextView.setText(doctname);
