...
import com.doc24x7.Video.model.Constant;
...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     * @param uid User ID.
     */
    public final void joinChannel(final String channel, int uid,String accessTokena) {
        String accessToken = accessTokena;
